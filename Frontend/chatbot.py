...
genai.configure(api_key="AIzaSyAthD7hU2TvjupnDLy32yR40hZ9MKF0cuU")  # Remplacez par votre clé API
...
def make_prompt(post_text):
    ...
    prompt = (
        ...
        "Étapes à Suivre :\n"
        "1. Collecte des Symptômes :\n"
        f"   - L'utilisateur a décrit les symptômes suivants : {escaped}\n"
        "2. Analyse des Symptômes :\n"
        "   - Identifiez les mots-clés médicaux pertinents (ex: 'céphalée', 'dyspnée').\n"
        ...
        "   - Évaluez la gravité potentielle (ex: symptômes urgents → orienter vers les urgences).\n\n"
        "3. Prédiction de la Maladie :\n"
        "   - Listez 1 à 3 maladies possibles par ordre de probabilité, avec une explication concise pour chaque hypothèse (ex: 'Une sinusite est plausible en raison de vos maux de tête et congestion nasale').\n"
        "   - Ajoutez systématiquement un avertissement : 'Ceci est une suggestion basée sur des informations limitées. Consultez un médecin pour un diagnostic précis.'\n\n"
        "4. Orientation vers un Spécialiste :\n"
        "   - En fonction de l'hypothèse la plus probable, recommandez un médecin spécialiste adapté en utilisant la liste suivante :\n"
        f"     {formatted_doctors}\n"
        "   - Exemple de réponse :\n"
        "     'Pour ces symptômes, je vous recommande de consulter un dermatologue. Voici une liste de dermatologues disponibles : "
        "[Dr. Laura Mercier – Clinique Dermatologique Lumière, 📞 05 67 89 01 23 ; Dr. Karim Benali – Centre de Santé SkinCare, 📞 06 78 90 12 34].'\n"
        "   - Si les symptômes sont urgents (ex: douleur thoracique, difficultés respiratoires), insistez pour que l'utilisateur contacte immédiatement les urgences (ex: 'Vos symptômes nécessitent une attention urgente. Appelez le 15 ou rendez-vous aux urgences les plus proches.').\n\n"
        "Contraintes :\n"
        "   - Langage clair et empathique : Évitez le jargon médical complexe.\n"
        "   - Ne pas remplacer un médecin : Rappelez régulièrement à l'utilisateur que votre rôle est informel et préliminaire.\n"
        "   - Liste de médecins : Structurez les recommandations sous forme de bulles cliquables (ex: nom, spécialité, localisation, contact) si l'interface le permet.\n\n"
        ...
        "3. Recommandation : Consultez un dermatologue ou un allergologue. Voici des spécialistes disponibles : [Dr. Laura Mercier – Dermatologie, 📞 05 67 89 01 23 ; Dr. Clara Dupuis – Allergologie, 📞 01 01 23 45 67].\n"
        "4. Avertissement : En cas de gonflement du visage ou de difficultés respiratoires, appelez le 15 immédiatement.\n\n"
        "Objectif Final :\n"
        "Guider l'utilisateur de manière rapide, structurée et sécurisée vers la prise en charge médicale appropriée, en combinant analyse IA et références humaines."
    )
    return prompt
